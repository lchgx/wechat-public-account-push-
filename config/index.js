...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wxe77a3cda7e1bdd50',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '40f697868f1a2047692a789eb1ce1250  ',
  ...
  USERS: [
    {
      ...
      id: 'o6Goj6WLzMsyxnhFq5XfB8XBQyts',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'gRTsa3rvyoqUhpf41znQ2DFrdz68_Wf068cHAte7Glk',
      // 所在省份
      province: '浙江',
      // 所在城市
      city: '温州',
